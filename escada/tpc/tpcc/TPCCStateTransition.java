...
* loads the possible states according to the TPC-C's definitions and initialize
* the base values used to calculate the thinktime and the keyingtime of each 
* state (transaction). It also defines the probability of occurrence for each state.
**/
